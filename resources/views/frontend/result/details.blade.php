...
<div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12 d-block mx-auto">
                        <div class="box_wrapper p-5">
                            <h4 class="text-center">Check Your Result </h4>
                          
                            <div class="row">
                              <div class="col-md-12">
                                  <div class="alert alert-success opacity" id="msg_div">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#download-result-form').on('submit', function(e) {
                e.preventDefault();
