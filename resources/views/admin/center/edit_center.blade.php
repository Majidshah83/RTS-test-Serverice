@extends('admin.app')
@section('title', 'Admin|Edit Center')
@section('stylesheets')
              ...
              <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Center
                    </li>
                  </ol>
                </div>
              </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <h4 class="form-section" align="center">Edit Center</h4>
                  <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                </div>
                <div class="card-content collapse show">
                  <div class="card-body">
                    <div class="card-text">
                    <form class="form" method="POST" action="{{url('/update/center')}}" enctype="multipart/form-data" novalidate>
                      <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <input type="hidden" name="center_id" value="{{$testCenter->center_id}}">
                      <div class="form-body">
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <div class="controls">
                              <input class="form-control border-primary" name="center_name" type="text" placeholder="Center Name" id="userinput5"  value="{{ $testCenter->center_name }}" required data-validation-required-message="This field is required">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <div class="controls">
                              <select id="projectinput6" name="city" class="form-control"  required data-validation-required-message="This field is required">
                                <option value="{{ $testCenter->city_id }}">{{$testCenter->city->city_name}}</option>
                                @foreach($allCities as $allCity)
                                @if($testCenter->city_id!=$allCity->city_id)
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <div class="controls">
                               <input type="number" class="form-control border-primary"  name="candidate_capacity" value="{{$testCenter->candidate_per_center }}" pattern="[0-9 ]+" placeholder="Candidate Capacity" required data-validation-required-message="This field is required">
                              </div> 
                            </div>
                          </div>
                      </div>
