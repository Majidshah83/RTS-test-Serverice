@extends('admin.app')
@section('title', 'Admin|Answer Key')
@section('stylesheets')
      ...
      <div class="content-body">
        ...
        <!-- Revenue, Hit Rate & Deals -->
          <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
              <h3 class="content-header-title mb-0 d-inline-block">Answer Key</h3>
              <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{url('/admin')}}">Dashboard</a>
                    </li>
                    <li class="breadcrumb-item active">Answer Key
                    </li>
                  </ol>
                </div>
              </div>
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    <div class="card-text">
                    <form class="form" method="POST" action="{{url('updateCreate')}}" enctype="multipart/form-data" novalidate>
                      <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <div class="form-body">
                        <input class="form-control border-primary" name="post_id" type="text" placeholder="Center Name" id="userinput5"  value="{{$id}}" required data-validation-required-message="This field is required">
                        <div class="row">
                            <div class="col-md-12 m-auto">
                              <div class="form-group {{$errors->has('news') ? 'has-error' : ''}}">
                                <label for="userinput1">News<span class="danger">*</span></label>
                                <div class="controls form-control">
                                <input class="form-control border-primary" name="key" type="file" placeholder="Center Name" id="userinput5"  value="{{ old('key') }}" required data-validation-required-message="This field is required">
                                </div>
                              </div>
                            </div>
                        </div> 
                      ...
                      <button type="submit" class="btn btn-success ">Add Answer Key
                      </button>
                      </div>
                    </form>
                  </div>
