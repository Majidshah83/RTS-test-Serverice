          ...
          <ul class="nav navbar-nav float-right">
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                ...
                @if(empty(Auth::user()->image))
                  ...
                  <span class="avatar avatar-online">
                    ...
                    <img  src="{{ asset('public/adminimages/dummy.jpg') }}"  alt="avatar"><i></i></span>
                  ...
                  <span class="avatar avatar-online">
                    ...
                    <img  src="{{ asset('public/candidatepicture') }}/{{Auth::user()->image}}"  alt="avatar"><i></i></span>
                  ...
                  @else
                   ...
                   <span class="avatar avatar-online">
                    ...
                    <img  src="{{ asset('public/adminimages') }}/{{Auth::user()->image}}"  alt="avatar"><i></i></span>
              ...
              <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" @if(Auth::user()->role!="candidate") href="
                ...
                <a class="dropdown-item" class="dropdown-item"  data-toggle="modal" data-target="#exampleModal"><i class="ft-user"></i> Change Password</a>
    ...
    <div class="navbar-container main-menu-content container center-layout" data-menu="menu-container">
      <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class="dropdown nav-item" data-menu="dropdown">
          ...
          <a class="dropdown-toggle nav-link" href="{{url('/dashboard')}}"><i class="la la-home"></i>
            <span>Dashboard</span>
          </a>
    
        </li>

        <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="{{URL('/country/all')}}" data-toggle="dropdown"><i class="la la-columns"></i><span>Center & Location</span></a>
          <ul class="dropdown-menu">

           {{--  <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu">
              <a class="dropdown-item" href="{{URL('/country/all')}}"><i class="la la-briefcase"></i>All</a>
            </li> --}}

            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu">

              <a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i class="la la-briefcase"></i>Project</a>
              <ul class="dropdown-menu">
                <li data-menu=""><a class="dropdown-item" href="{{URL('/location')}}" data-toggle="dropdown">All Location</a>
                </li>
                <li data-menu=""><a class="dropdown-item"  href="{{URL('/current/center')}}" data-toggle="dropdown">All Center</a>
                </li>
              </ul>
            </li>
        ...
        @endif
        <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="{{URL('/current/projects')}}"><i class="la la-folder-open"></i><span>Projects</span></a>
          
        </li>
        @if(Auth::user()->role=="Superadmin" || Auth::user()->role=="Admin")
        <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="{{url('/news')}}"><i class="la la-file-text"></i><span>News Managment</span></a>
        
        </li>
         @endif
         @if(Auth::user()->role=="Superadmin" || Auth::user()->role=="Admin")
        <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="{{url('/result')}}"><i class="la la-pencil"></i><span>Result Managment</span></a>
        
        </li>
         @endif

         @if(Auth::user()->role != "Operator")
        <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="{{url('/paper/pattern')}}"><i class="la la-th-list"></i><span>Paper Pattern</span></a>
        
        </li>
        <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="{{url('/create/sms')}}"><i class="la la-plus-square"></i><span>Send SMS</span></a>
