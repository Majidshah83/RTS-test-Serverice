      ...
      <div class="content-body">
        ...
        <!-- Revenue, Hit Rate & Deals -->
          <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
              <h3 class="content-header-title mb-0 d-inline-block">Send SMS</h3>
              <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{url('/admin')}}">Dashboard</a>
                    </li>
                    <li class="breadcrumb-item"><a href="#">Send SMS</a>
                    </li>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <h4 class="form-section" align="center">Send SMS</h4>
                  <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                </div>
                <div class="card-content collapse show">
                  <div class="card-body">
                    <div class="card-text">
                    <form class="form" method="POST" action="{{url('/send/sms')}}" novalidate>
                      <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <div class="form-body"> 
                        <div class="row">
                            <div class="col-md-12 m-auto">
                              <div class="form-group {{$errors->has('msg') ? 'has-error' : ''}}">
                                <label for="userinput1">Message<span class="danger">*</span></label>
                                <div class="controls">
                                <textarea rows="10" class="form-control" cols="133" name="msg" required data-validation-required-message="This field is required"></textarea>
