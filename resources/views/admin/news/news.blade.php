...
@section('content')
             ...
             <div class="row">
              <div class="col-12">
                ...
                <div class="card-header">
                  <h4 class="form-section" align="center"></i>News</h4>
                  @if(Auth::user()->role=="Superadmin")
                      <a href="{{url('/news/create')}}">
                        <button type="button" class="btn btn-success btn-min-width box-shadow-2 mr-1 mb-1"><i class="ft-plus"></i>Add News</button>
                      </a>
                  @endif
                  </div>
                       ...
                       <tbody>
                        @foreach($news as $key=>$news)
                          <tr>
                            ...
                            <button type="button" onclick="remove({{$news->id}})" data-toggle="modal"  class="btn btn-outline-danger" data-tooltip="tooltip" title="Delete">Delete</button>
                            </center>
                            </td>
                          </tr>
                        @endforeach()
  ...
  <script type="text/javascript">
    function remove(id) {
        swal({
          title: "Are you sure?",
          text: "You are about to delete the news, this procedure is irreversible!",
          icon: "warning",
          buttons: {
                  cancel: {
                      text: "No, cancel plx!",
