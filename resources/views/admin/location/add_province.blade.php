@extends('admin.app')
@section('title', 'Admin|Add Province')
@section('stylesheets')
              ...
              <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add New Province
                    </li>
                  </ol>
                </div>
              </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <h4 class="form-section" align="center">Add New Province</h4>
                  <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                </div>
                <div class="card-content collapse show">
                  <div class="card-body">
                    <div class="card-text">
                    <form class="form" method="POST" action="{{url('/add/province')}}" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-8">
                            <div class="form-group">
                              ...
                              <div class="controls">
                              <input class="form-control border-primary" name="province" type="text" placeholder="Province Name" id="userinput5"  value="{{ old('province') }}" required data-validation-required-message="This field is required">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-2">
