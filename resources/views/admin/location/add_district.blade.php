@extends('admin.app')
@section('title', 'Admin|Add District')
@section('stylesheets')
              ...
              <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{url('/province/district/'.$province->pro_id)}}">All District</a>
                    </li>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <a href="{{url('/province/district/'.$province->pro_id)}}">
                        <button type="button" class="btn btn-danger btn-min-width box-shadow-2 mr-1 mb-1"><i class="ft-chevron-left"></i>Back</button>
                  </a>
                  <h4 class="form-section" align="center">Add New District</h4>
                  <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                </div>
                <div class="card-content collapse show">
                  <div class="card-body">
                    <div class="card-text">
                    <form class="form" method="POST" action="{{url('/create/district')}}" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-8">
                            <div class="form-group">
                              ...
                              <div class="controls">
                              <input class="form-control border-primary" name="district" type="text" placeholder="District" id="userinput5"  value="{{ old('district') }}" required data-validation-required-message="This field is required">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-2">
