@extends('admin.app')
@section('title', 'Admin|Edit Cites')
@section('stylesheets')
              ...
              <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{url('/province/cities/'.$editCities->pro_id)}}">All Cities</a>
                    </li>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <a href="{{url('/province/cities/'.$editCities->pro_id)}}">
                        <button type="button" class="btn btn-danger btn-min-width box-shadow-2 mr-1 mb-1"><i class="ft-chevron-left"></i>Back</button>
                  </a>
                  <h4 class="form-section" align="center">Edit City</h4>
                  <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                </div>
                <div class="card-content collapse show">
                  <div class="card-body">
                    <div class="card-text">
                    <form class="form" method="POST" action="{{url('/update/city')}}" enctype="multipart/form-data" novalidate>
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <input type="hidden" name="city_id" value="{{$editCities->city_id}}">
                      <div class="form-body">
                        <div class="row">
                          <div class="col-md-2">
                          </div>
                          <div class="col-md-8">
                            <div class="form-group">
                              ...
                              <div class="controls">
                              <input class="form-control border-primary" name="province" type="text" placeholder="Province" id="userinput5"  value="{{$editCities->province->pro_name}}" readonly="true" required data-validation-required-message="This field is required">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-2">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-8">
                            <div class="form-group">
                              <label for="userinput1">City Name<span class="danger">*</span></label>
                              <div class="controls">
                              <input class="form-control border-primary" name="city" type="text" placeholder="District" id="userinput5"  value="{{$editCities->city_name}}" required data-validation-required-message="This field is required">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-2">
