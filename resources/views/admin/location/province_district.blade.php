@extends('admin.app')
 @section('title', 'Admin|All District')
             ...
             <div class="row">
              <div class="col-12">
                ...
                <div class="card-header">
                  <h4 class="form-section" align="center"></i>{{$province->pro_name}} District</h4>
                  ...
                  <a href="{{url('/add/district/'.$province->pro_id)}}">
                    <button type="button" class="btn btn-success btn-min-width box-shadow-2 mr-1 mb-1"><i class="ft-plus"></i>Add New District</button>
                  </a>
                </div>
                      ...
                      <thead>
                       ...
                       @foreach($district as $key=>$districts)
                          <tr>
                            ...
                            <td>{{++$key}}</td>
                            <td>{{$districts->dist_name}}</td>
                            <td>
                            <center>   
                            <a href="{{url('/edit/district', $districts->dist_id)}}">
                            <button type="button" class="btn btn-outline-success" aria-haspopup="true" aria-expanded="false">Edit</button>
                            </a>
                            <button type="button" onclick="remove({{$districts->dist_id}});"  data-toggle="modal"  class="btn btn-outline-danger delete_class" data-tooltip="tooltip" title="Delete">Delete</button>
                            </center>
                            </td>
