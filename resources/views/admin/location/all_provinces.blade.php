...
@section('content')
      <div class="content-body">
        ...
        <!-- Revenue, Hit Rate & Deals -->
          <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
              <h3 class="content-header-title mb-0 d-inline-block">Provinces</h3>
              <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{url('/dashboard')}}">Dashboard</a>
                    </li>
                    <li class="breadcrumb-item active">Provinces
                    </li>
                  </ol>
                </div>
              </div>
             ...
             <div class="row">
              <div class="col-12">
                ...
                <div class="card-header">
                  <h4 class="form-section" align="center"></i>Provinces</h4>
                  <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                  <a href="{{url('/create/province')}}">
                    <button type="button" class="btn btn-success btn-min-width box-shadow-2 mr-1 mb-1"><i class="ft-plus"></i>Add New Province</button>
                  </a>
                </div>
                      ...
                      <thead>
                       ...
                       @foreach($province as $key=>$provinces)
                          <tr>
                            ...
                            <td>{{++$key}}</td>
                            <td>{{$provinces->pro_name}}</td>
                            <td>
                            <center>   
                            <a href="{{url('/province/district', $provinces->pro_id)}}">
                            <button type="button" class="btn btn-outline-info" aria-haspopup="true" aria-expanded="false">View All Districts</button>
                            </a>
                            <a href="{{url('/province/cities', $provinces->pro_id)}}">
                            <button type="button" class="btn btn-outline-primary" aria-haspopup="true" aria-expanded="false">View All Cities</button>
                            </a>
                            <a href="{{url('/edit/province', $provinces->pro_id)}}">
                            <button type="button" class="btn btn-outline-success" aria-haspopup="true" aria-expanded="false">Edit</button>
                            </a>
                            <button type="button" onclick="remove({{$provinces->pro_id}})" data-toggle="modal"  class="btn btn-outline-danger delete_class" data-tooltip="tooltip" title="Delete">Delete</button>
                            </center>
                            </td>
  ...
  <script type="text/javascript">
    function remove(id) {
        swal({
          title: "Are you sure?",
          text: "You are about to delete the province, this procedure is irreversible!",
          icon: "warning",
          buttons: {
                  cancel: {
                      text: "No, cancel plx!",
