      ...
      <div class="content-body">
        ...
        <!-- Revenue, Hit Rate & Deals -->
          <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
              <h3 class="content-header-title mb-0 d-inline-block"> Eligible/ Non Eligible List</h3>
              <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Upload Eligible/ Non Eligible List
                    </li>
                  </ol>
                </div>
              </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <h4 class="form-section" align="center">Upload Eligible/ Non Eligible List</h4>
                  <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                </div>
                <div class="card-content collapse show">
                  <div class="card-body">
                   <div class="card-text">
                    <form class="form" method="POST" action="{{url('/store/eligible/noneligible')}}" enctype="multipart/form-data" novalidate>
                      ...
                      <div class="form-body">
                        ...
                        <div class="row">
                          <div class="col-md-6 m-auto">
                            <div class="form-group">
                              <label for="userinput1">Upload List (Excel Format) <span class="danger">*</span></label>
                              <div class="controls">
                              <input class="form-control border-primary" name="eligible" type="file" placeholder="Upload Result" id="eligible"  value="{{ old('eligible') }}" required data-validation-required-message="This field is required" >
                              </div>
                            </div>
                          </div>
                        </div>
