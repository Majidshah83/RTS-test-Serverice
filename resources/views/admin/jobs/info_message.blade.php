@extends('admin.app')
@section('title', 'Admin|Information Message')
@section('stylesheets')
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <a href="{{url('post/apply/candidate/'.$projectInfo->ad_id)}}">
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    <div class="card-text">
                    <form class="form" method="POST" action="{{url('/info/message')}}" enctype="multipart/form-data" novalidate>
                      <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <input type="hidden" name="id" value="{{ $projectInfo->ad_id }}">
                      <div class="form-body">
                        <div class="row">
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <div class="controls">
                                <input class="form-control border-primary" name="job_title" type="text" placeholder="Project Title" id="userinput5"  value="{{ $projectInfo->ad_title }}" readonly="true">
                                </div>
                              </div>
                            </div>
                        </div>   
                        <div class="row">
                            <div class="col-md-12 m-auto">
                              <div class="form-group">
                                ...
                                <div class="controls">
                                <textarea class="form-control"  rows="5" name="info_message" required data-validation-required-message="This field is required" value={{old('info_message')}}>
                                </textarea>
                                </div>
                              </div>
                            </div>
