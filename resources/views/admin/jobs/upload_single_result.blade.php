            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <h4 class="form-section" align="center">Upload Result</h4>
                  <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                </div>
                <div class="card-content collapse show">
                  <div class="card-body">
                   <div class="card-text">
                    <form class="form" method="POST" action="{{url('/add/single/result')}}" enctype="multipart/form-data" novalidate>
                      <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <input type="text" name="ad_id" value="{{$CandidateInfo->post->ad_id}}">
                      <input type="text" name="nic" value="{{$CandidateInfo->nic}}">
                      <input type="text" name="candidate_id" value="{{$CandidateInfo->candidate_id}}">
                      <div class="form-body">
                        <div class="row">
                          <div class="col-md-6 m-auto">
                            <div class="form-group">
                              ...
                              <div class="controls">
                              <input class="form-control border-primary" name="job_title" type="text" placeholder="Project Title" id="job_title"  value="{{$CandidateInfo->post->ad_title}}" required data-validation-required-message="This field is required" readonly="true">
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-6 m-auto">
                            <div class="form-group">
                              ...
                              <div class="controls">
                              <input class="form-control border-primary" name="result" type="number" placeholder="Upload Result"  value="{{ old('result') }}" required data-validation-required-message="This field is required" >
                              </div>
                            </div>
                          </div>
                        </div>
