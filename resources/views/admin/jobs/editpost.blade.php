            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <a href="{{url('/view/post/'.$post->job_id)}}">
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                   <div class="card-text">
                    <form class="form" method="POST" action="{{url('/update/post')}}" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="row">
                          <div class="col-md-6 m-auto">
                            <div class="form-group">
                              <label for="userinput1">Update  <span class="danger">*</span></label>
                              <div class="controls">
                              <input class="form-control border-primary" name="post" type="text" placeholder="Upload Result" id="post"  value="{{ $post->type_name }}" >
